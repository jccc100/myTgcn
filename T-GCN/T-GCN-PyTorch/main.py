...
DATA_PATHS = {
    "shenzhen": {"feat": "data/pems04.csv", "adj": "data/pems04_adj.csv"},
    "losloop": {"feat": "data/pems08.csv", "adj": "data/pems08_adj.csv"},
}
...
def main_supervised(args):
    ...
    trainer = pl.Trainer.from_argparse_args(args,gpus=1,max_epochs=500, callbacks=callbacks)
    trainer.fit(task, dm)
